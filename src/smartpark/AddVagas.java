...
public class AddVagas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Ocupar vaga...", jPanel1);
        ...
        jTabbedPane1.addTab("Vagas ocupadas", jPanel2);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        //Montar a lista em vagas
        listVagas.setListData(vagas);
        listVagas.setCellRenderer(new DefaultListCellRenderer() {
            @Override
            public Component getListCellRendererComponent(JList<?> list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                Component renderer = super.getListCellRendererComponent(list, value, index, isSelected, cellHasFocus);
                if (renderer instanceof JLabel && value instanceof Vaga) {
                    
                    
                    ((JLabel) renderer).setText(Long.toString(((Vaga) value).getId()));
                }
                return renderer;
            }
        });
